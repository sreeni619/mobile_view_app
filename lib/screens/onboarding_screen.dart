  ...
  List slidersList(BuildContext context) => [
        {
          ...
          'image': Theme.of(context).colorScheme.onboardingImage1,
          'desc': CustomStrings.onboardingDesc1
        },
        {
          'title': CustomStrings.onboardingTitle2,
          'image': Theme.of(context).colorScheme.onboardingImage2,
          'desc': CustomStrings.onboardingDesc2
        },
        {
          'title': CustomStrings.onboardingTitle3,
          'image': Theme.of(context).colorScheme.onboardingImage3,
